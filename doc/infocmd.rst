...
As input parameter, user can specify:
  ...
  * Single reference::
    ...
    By usging -r parameter, you can tell swgit info to operate on a specific reference
...
Here, we will report some examples usefull in every-day developer-life:
