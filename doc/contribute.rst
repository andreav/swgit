...
swgit is a project developed entirely in my spare time, so its growth and
...
#.  **Documentation**: The documentation can always use improvements.  Right now
    ...
    - Write translations.  swgit gets visitors from all over the world and it
...
#.  **Feature Requests**: I would
    like to encourage people to voice their opinion on what they think
    should be added or changed in swgit.  Once again, nothing is too small to
...
#.  **Code Contributions**: In addition to reporting bugs or requesting
    ...
    should a change to swgit possibly affect what you are working on.
